...
public final class ProfileFragmentBinding implements ViewBinding {
  ...
  @NonNull
  public final ProfileLayout profileView;

  private ProfileFragmentBinding(@NonNull LinearLayout rootView,
      @NonNull ProfileLayout profileView) {
  ...
  public static ProfileFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ProfileLayout profileView = rootView.findViewById(id);
      if (profileView == null) {
        break missingId;
      }

      return new ProfileFragmentBinding((LinearLayout) rootView, profileView);
    }
